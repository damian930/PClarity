...
#define __UI_STACK_DATA_TABLE_EXPANSION(EXPANSION) \
  EXPANSION(__UI_Additional_box_flags_stack,      UI_Box_flags, stack_additonal_box_flags, UI_Box_flag__NONE, ui_push_extra_flags,         ui_next_extra_flags,         ui_pop_extra_flags,         ui_auto_pop_extra_flags,         ui_top_extra_flags, 64, UI_ExtraFlags) \
  \
  EXPANSION(__UI_Size_x_stack,         UI_Size, stack_size_x,         ui_fit(), ui_push_size_x,         ui_next_size_x,         ui_pop_size_x,         ui_auto_pop_size_x,         ui_top_size_x, 64, UI_SizeX) \
  EXPANSION(__UI_Size_y_stack,         UI_Size, stack_size_y,         ui_fit(), ui_push_size_y,         ui_next_size_y,         ui_pop_size_y,         ui_auto_pop_size_y,         ui_top_size_y, 64, UI_SizeY) \
  \
  EXPANSION(__UI_Child_gap_stack,      F32,     stack_child_gap,      0.0f,     ui_push_child_gap,      ui_next_child_gap,      ui_pop_child_gap,      ui_auto_pop_child_gap,      ui_top_child_gap, 64, UI_Childgap) \
  \
  EXPANSION(__UI_Padding_left_stack,   F32,     stack_padding_left,   0.0f,     ui_push_padding_left,   ui_next_padding_left,   ui_pop_padding_left,   ui_auto_pop_padding_left,   ui_top_padding_left, 64, UI_PaddingLeft) \
  EXPANSION(__UI_Padding_top_stack,    F32,     stack_padding_top,    0.0f,     ui_push_padding_top,    ui_next_padding_top,    ui_pop_padding_top,    ui_auto_pop_padding_top,    ui_top_padding_top, 64, UI_PaddingTop) \
  EXPANSION(__UI_Padding_right_stack,  F32,     stack_padding_right,  0.0f,     ui_push_padding_right,  ui_next_padding_right,  ui_pop_padding_right,  ui_auto_pop_padding_right,  ui_top_padding_right, 64, UI_PaddingRight) \
  EXPANSION(__UI_Padding_bottom_stack, F32,     stack_padding_bottom, 0.0f,     ui_push_padding_bottom, ui_next_padding_bottom, ui_pop_padding_bottom, ui_auto_pop_padding_bottom, ui_top_padding_bottom, 64, UI_PaddingBottom) \
  \
  EXPANSION(__UI_Layout_axis_stack, Axis2, stack_layout_axis, Axis2__y,     ui_push_layout, ui_next_layout, ui_pop_layout, ui_auto_pop_layout, ui_top_layout, 64, UI_Layout) \
  \
  EXPANSION(__UI_Background_color_stack, V4F32, stack_background_color, v4f32_all(0.0f), ui_push_background_color, ui_next_background_color, ui_pop_background_color, ui_auto_pop_background_color, ui_top_background_color, 64, UI_BColor) \
  \
  EXPANSION(__UI_Corner_radius_top_left_stack,     F32, stack_corner_radius_top_left,     0.0f, ui_push_corner_radius_top_left,     ui_next_corner_radius_top_left,     ui_pop_corner_radius_top_left,     ui_auto_pop_corner_radius_top_left,     ui_top_corner_radius_top_left, 64, UI_CornerRadiusTopLeft) \
  EXPANSION(__UI_Corner_radius_top_right_stack,    F32, stack_corner_radius_top_right,    0.0f, ui_push_corner_radius_top_right,    ui_next_corner_radius_top_right,    ui_pop_corner_radius_top_right,    ui_auto_pop_corner_radius_top_right,    ui_top_corner_radius_top_right, 64, UI_CornerRadiusTopRight) \
  EXPANSION(__UI_Corner_radius_bottom_right_stack, F32, stack_corner_radius_bottom_right, 0.0f, ui_push_corner_radius_bottom_right, ui_next_corner_radius_bottom_right, ui_pop_corner_radius_bottom_right, ui_auto_pop_corner_radius_bottom_right, ui_top_corner_radius_bottom_right, 64, UI_CornerRadiusBottomRight) \
  EXPANSION(__UI_Corner_radius_bottom_left_stack,  F32, stack_corner_radius_bottom_left,  0.0f, ui_push_corner_radius_bottom_left,  ui_next_corner_radius_bottom_left,  ui_pop_corner_radius_bottom_left,  ui_auto_pop_corner_radius_bottom_left,  ui_top_corner_radius_bottom_left, 64, UI_CornerRadiusBottomLeft) \
  \
  EXPANSION(__UI_Border_color_stack, V4F32, stack_border_color, v4f32_all(0.0f), ui_push_border_color, ui_next_border_color, ui_pop_border_color, ui_auto_pop_border_color, ui_top_border_color, 64, UI_BorderColor) \
  \
  EXPANSION(__UI_Border_left_stack,   F32, stack_border_left,   0.0f, ui_push_border_left,   ui_next_border_left,   ui_pop_border_left,   ui_auto_pop_border_left,   ui_top_border_left, 64, UI_BorderLeft) \
  EXPANSION(__UI_Border_right_stack,  F32, stack_border_right,  0.0f, ui_push_border_right,  ui_next_border_right,  ui_pop_border_right,  ui_auto_pop_border_right,  ui_top_border_right, 64, UI_BorderRight) \
  EXPANSION(__UI_Border_top_stack,    F32, stack_border_top,    0.0f, ui_push_border_top,    ui_next_border_top,    ui_pop_border_top,    ui_auto_pop_border_top,    ui_top_border_top, 64, UI_BorderTop) \
  EXPANSION(__UI_Border_bottom_stack, F32, stack_border_bottom, 0.0f, ui_push_border_bottom, ui_next_border_bottom, ui_pop_border_bottom, ui_auto_pop_border_bottom, ui_top_border_bottom, 64, UI_BorderBottom) \
  \
  EXPANSION(__UI_Parent_stack, UI_Box*, stack_parent, &__ui_g_null_box, ui_push_parent, ui_next_parent, ui_pop_parent, ui_auto_pop_parent, ui_top_parent, (64*3), UI_Parent) \
  \
