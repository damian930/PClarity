/*  date = July 15th 2026 11:21 AM  */

// ================================================================
// -----------Native API Forward Declarations----------------------
// ================================================================
...
extern "C" NTSYSAPI VOID NTAPI RtlTimeToTimeFields(
    _In_ PLARGE_INTEGER Time,
    _Out_ PTIME_FIELDS TimeFields
    );

extern "C" NTSYSAPI NTSTATUS NTAPI RtlSystemTimeToLocalTime(
