...
{
  Arena* arena = arena_alloc_ex(size_to_reserve, false, 0);
  return arena;
}

Arena* arena_alloc_ex(U64 size_to_reserve, B32 start_at_specific_page, U32 allocation_granulatity_index)
{
